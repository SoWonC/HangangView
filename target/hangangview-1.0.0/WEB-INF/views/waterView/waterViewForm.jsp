...
<div class="notices_list">
            <h1>갈수 전망 등록하기</h1>
            <form:form action="${pageContext.request.contextPath}/waterView/add" method="post" modelAttribute="waterView" enctype="multipart/form-data">
                <div>
                ...
                <input type="submit" value="갈수 전망 등록"/>
            </form:form>
            <button onclick="location.href='/project_1108/waterViews'">취소</button>
</div>
</body>
</html>
