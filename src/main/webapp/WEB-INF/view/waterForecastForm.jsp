...
<div class="notices_list">
            <h1>갈수 예보 등록하기</h1>
            <form:form action="${pageContext.request.contextPath}/waterForecast/add" method="post" modelAttribute="waterForecast" enctype="multipart/form-data">
                <div>
                ...
                <input type="submit" value="갈수 예보 등록"/>
            </form:form>
            <button onclick="location.href='/project_1108/waterForecasts'">취소</button>
</div>
</body>
</html>
