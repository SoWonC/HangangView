...
<c:set var="sessionName" value="${sessionScope.authInfo != null ? sessionScope.authInfo.name : null}" />
		...
		<div class="admin_move_buttons">
			<input type="button" value="수문 정보 관리" class="choose_button" onclick="location.href='/project_1108/information_management'">
			<input type="button" value="용수 관리" class="inf_manage" onclick="location.href='/project_1108/water_management'">
			<input type="button" value="회원 관리" class="inf_manage" onclick="location.href='/project_1108/member_management'">
		</div>
</body>
</html>