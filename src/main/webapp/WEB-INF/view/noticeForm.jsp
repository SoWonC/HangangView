...
<div class="notices_list">
            <h1>공지사항 등록하기</h1>
            <form:form action="${pageContext.request.contextPath}/notice/add" method="post" modelAttribute="notice" enctype="multipart/form-data">
                <div>
            ...
            <button onclick="location.href='/project_1108/notices'">취소</button>
            </div>
</body>
</html>
